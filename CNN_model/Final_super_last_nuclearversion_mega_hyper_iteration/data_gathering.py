...
def init_mediapipe(model_path="hand_landmarker.task"):
    """
...
def gather_data(photos_dir, letter_folders, mediapipe_model="hand_landmarker.task"):
    """
    ...
    Args:
        ...
        mediapipe_model: Path to MediaPipe model file
